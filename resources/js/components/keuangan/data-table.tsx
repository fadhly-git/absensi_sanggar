...
export function DataTableKeuangan() {
    ...
    return (
        <div className="mx-2 w-auto items-center justify-center lg:mx-4">
            <div className="w-fit">
                <h1 className="mt-6 text-xl font-bold">Tabel Keuangan</h1>
            </div>
                    ...
                    <TableBody>
                        {table.getRowModel().rows?.length ? (
                            table.getRowModel().rows.map((row) => (
                                <TableRow className="mx-auto capitalize" key={row.id} data-state={row.getIsSelected() && 'selected'}>
