...
export function KeuanganKlrEditTabs({ open, openDialog, data }: UangKeluarField) {
        ...
        <Drawer open={open} onOpenChange={openDialog}>
            <DrawerContent>
                <div className="mx-auto w-full max-w-xl p-4">
                    <DrawerHeader>
                        <DrawerTitle>Edit Data Uang Keluar</DrawerTitle>
